...
export default function Hero() {
    return (
        <section className="relative w-full overflow-hidden bg-white pt-28 md:pt-40 pb-20 md:pb-32">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center mt-8 md:mt-20">
                ...
                >
                    ...
                    <span className="text-orange-900 text-sm font-medium">Institutional-grade wealth creation</span>
                </motion.div>
                ...
                >
                    Emerging Leaders. <br className="hidden md:block" />
                    <span className="text-primary">Enduring Wealth.</span>
                </motion.h1>
                ...
                <motion.div
                    ...
                    className="flex flex-wrap justify-center items-center gap-4 md:gap-6 text-xs sm:text-sm text-slate-500 font-bold uppercase tracking-wide mb-12 md:mb-20"
                >
